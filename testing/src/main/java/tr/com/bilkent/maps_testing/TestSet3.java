...
/**
 * Third test set. Includes test cases for testing various combinations of
 * coordinates.
 */
public class TestSet3 implements TestSet {
	...
	public TestSet3(WebDriver driver) {
		JSONTokener tokener = new JSONTokener(getClass().getResourceAsStream("TestCaseThreeData.json"));
