...
/**
 * Second test set. Includes test cases for testing various combinations of
 * coordinates.
 */
public class TestSet2 implements TestSet {
	...
	public TestSet2(WebDriver driver) {
		JSONTokener tokener = new JSONTokener(getClass().getResourceAsStream("TestCaseTwoData.json"));
